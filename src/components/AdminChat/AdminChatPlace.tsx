...
const AdminChatPlace = () => {
    return (
        <div className="flex flex-col h-full w-full ml-82 m-2 bg-white border rounded-xl overflow-hidden">
            {/* Header */}
            ...
            <div className="flex-1 px-4 py-6 overflow-y-auto bg-gray-50 h-screen">
                ...
                <div className="flex justify-end">
                    <div className="max-w-[70%] bg-blue-700 text-white px-4 py-3 rounded-2xl rounded-br-sm shadow">
