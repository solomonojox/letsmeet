        ...
        <div className="w-full mt-6 p-4 bg-white rounded-lg border">
            ...
            {createNewUserModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900/50">
                    <div className='rounded-lg bg-white w-full max-w-4xl mx-auto p-4 relative space-y-4'>
                        <X onClick={() => setCreateNewUserModalOpen(false)} className='w-6 h-6 cursor-pointer absolute top-4 right-4' />
                        <p className='text-lg font-medium text-center'>New Account</p>

                        <form action="submit" className='w-full space-y-6'>
                            <div className="space-y-2">
                                <label htmlFor="name">Name of Company</label>
                                <input type="text" placeholder='What is the name of this company' className='w-full p-2 border outline-none focus:border-primary rounded-lg' />
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="enail">Email Address</label>
                                <input type="email" placeholder='Enter email address of this company' className='w-full p-2 border outline-none focus:border-primary rounded-lg' />
                            </div>

                            <div className="flex gap-4">
                                <button type='button' className='w-full p-2 border border-primary text-primary text-sm hover:bg-primary/10 rounded-lg' onClick={() => setCreateNewUserModalOpen(false)}>Clear All</button>

                                <button type="submit" className='w-full p-2 bg-primary text-white text-sm hover:bg-primary/70 rounded-lg'>Create Account</button>
                            </div>
                        </form>
                    </div>
                </div>
...
export default ViewReferralUsers;