                                    ...
                                    {openModal === user.id && (
                                        ...
                                        >
                                            <div className="py-3 px-4 border-b border-gray-200">
                                                <a href="#" className="text-gray-600 block text-left text-md hover:text-primary hover:underline hover:underline-offset-2" onClick={() => navigate(`/user/${user.id}`, { state: user })}>View profile</a>
                                            </div>
                                            <div className="p-4">
